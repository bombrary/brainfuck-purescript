...
(function($PS) {
  ...
  var programArea = function (isExecutable) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Events.onValueChange(ChangeProgram.create) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
  ...
  var outputArea = function (output) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Output: " + output) ]) ]);
  };
  ...
  var memoryLogArea = function (dptr) {
      return function (memory) {
          return Halogen_HTML_Elements.div_(mapWithASpecialIndex(dptr)(function (dat) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.style("background-color: salmon; margin-right: 1em;") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(dat)) ]);
          })(function (dat) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.style("background-color: white; margin-right: 1em;") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(dat)) ]);
          })(memory));
      };
  };
  var programLogArea = function (iptr) {
      return function (v) {
          return Halogen_HTML_Elements.div_(mapWithASpecialIndex(iptr)(function (cmd) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.style("background-color: salmon;") ])([ Halogen_HTML_Core.text(Data_Show.show(Brainfuck_Command["$_ShowCommand_2"])(cmd)) ]);
          })(function (cmd) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.style("background-color: white;") ])([ Halogen_HTML_Core.text(Data_Show.show(Brainfuck_Command["$_ShowCommand_2"])(cmd)) ]);
          })(v));
      };
  };
  var stateArea = function (program) {
      return function (v) {
          return Halogen_HTML_Elements.div_([ programLogArea(v.iptr)(program), memoryLogArea(v.dptr)(v.memory) ]);
      };
  };
  var interpResult = function (v) {
      var message = (function () {
          if (v.result instanceof Data_Either.Right) {
              return "Succeed";
          };
          if (v.result instanceof Data_Either.Left) {
              return Data_Show.show(Brainfuck_Error["$_ShowError_0"])(v.result.value0);
          };
          throw new Error("Failed pattern match at Component (line 170, column 9 - line 175, column 21): " + [ v.result.constructor.name ]);
      })();
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Result: " + message) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("iptr: " + Data_Show.show(Data_Show.showInt)(v.state.iptr)) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("dptr: " + Data_Show.show(Data_Show.showInt)(v.state.dptr)) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("memory: " + Data_Show.show(Data_Show.showArray(Data_Show.showInt))(v.state.memory)) ]) ]) ]) ]);
  };
  var inputArea = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueChange(ChangeInput.create) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
      return ConfirmInput.value;
  }) ])([ Halogen_HTML_Core.text("input") ]) ]);
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ programArea(state.isExecutable), (function () {
          if (state.isInputEnabled) {
              return inputArea;
          };
          return Halogen_HTML_Elements.div_([  ]);
      })(), outputArea(state.output), (function () {
          if (state.stateMay instanceof Data_Maybe.Just) {
              return stateArea(Brainfuck_Program.fromString(state.program))(state.stateMay.value0);
          };
          if (state.stateMay instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([  ]);
          };
          throw new Error("Failed pattern match at Component (line 92, column 7 - line 97, column 21): " + [ state.stateMay.constructor.name ]);
      })(), (function () {
          if (state.result instanceof Data_Maybe.Just) {
              return interpResult(state.result.value0);
          };
          if (state.result instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div_([  ]);
          };
          throw new Error("Failed pattern match at Component (line 98, column 7 - line 103, column 21): " + [ state.result.constructor.name ]);
      })() ]);
  };
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.create))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(v1.emitter))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $47.streamMay = Data_Maybe.Just.create(createStream(v1.listener)(s.avar));
                          $47.logMay = Data_Maybe.Just.create(createLog(v1.listener));
                          return $47;
                      });
                  });
              });
                  ...
                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.streamMay)(function (s) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.logMay)(function (l) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $57.output = "";
                              $57.result = Data_Maybe.Nothing.value;
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Brainfuck.run(Effect_Aff.monadAff)(s)(l)(Brainfuck_Program.fromString(v1.program))))(function (res) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      ...
                                      $60.result = new Data_Maybe.Just(res);
          ...
          if (v instanceof Output) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $66.output = s.output + Data_String_CodeUnits.singleton(v.value0);
                  return $66;
              });
          };
          ...
          if (v instanceof ConfirmInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Component (line 223, column 7 - line 229, column 20): " + [ v2.constructor.name ]);
              });
          };
          if (v instanceof RequestLogState) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $85.stateMay = new Data_Maybe.Just(v.value0);
                  return $85;
              });
          };
          throw new Error("Failed pattern match at Component (line 192, column 3 - line 232, column 45): " + [ v.constructor.name ]);
      };
  };
