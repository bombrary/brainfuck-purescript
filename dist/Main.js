...
(function($PS) {
  ...
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Unit = $PS["Data.Unit"];
  var noLog = function (dictMonad) {
      return {
          onStart: Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](dictMonad))(Data_Unit.unit),
          onState: function (v) {
              return Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](dictMonad))(Data_Unit.unit);
          },
          onCmd: function (v) {
          ...
          onEnd: Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](dictMonad))(Data_Unit.unit)
      };
  };
...
(function($PS) {
  ...
  var interpResult = function (v) {
      var message = (function () {
          ...
          throw new Error("Failed pattern match at Component (line 125, column 9 - line 130, column 21): " + [ v.result.constructor.name ]);
      })();
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ programArea(state.isExecutable), (function () {
          ...
          throw new Error("Failed pattern match at Component (line 84, column 7 - line 89, column 21): " + [ state.result.constructor.name ]);
      })() ]);
  };
      ...
      return function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.create))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(v1.emitter))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $33.streamMay = Data_Maybe.Just.create(createStream(v1.listener)(s.avar));
                          return $33;
                      });
                  });
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.streamMay)(function (s) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $43.output = "";
                          $43.result = Data_Maybe.Nothing.value;
                          $43.isExecutable = false;
                          return $43;
                      }))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Brainfuck.run(Effect_Aff.monadAff)(s)(Brainfuck_Interp_Log.noLog(Effect_Aff.monadAff))(Brainfuck_Program.fromString(v1.program))))(function (res) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $46.result = new Data_Maybe.Just(res);
                                  $46.isExecutable = true;
                                  return $46;
                              });
                          });
                      });
          ...
          if (v instanceof Output) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $51.output = s.output + Data_String_CodeUnits.singleton(v.value0);
                  return $51;
              });
          };
          ...
          if (v instanceof ConfirmInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Component (line 174, column 7 - line 180, column 20): " + [ v2.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Component (line 147, column 3 - line 180, column 20): " + [ v.constructor.name ]);
      };
  };
