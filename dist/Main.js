...
(function($PS) {
  ...
  var defaultStream = (function () {
      var output = function (c) {
          return Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](Effect_Class.monadEffectEffect))(Effect_Console.log(Data_Show.show(Data_Show.showChar)(c)));
      };
      var input = Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](Effect.monadEffect))("N");
      return {
          input: input,
          output: output
      };
...
(function($PS) {
  ...
  var interpResult = function (v) {
      var message = (function () {
          ...
          throw new Error("Failed pattern match at Component (line 79, column 9 - line 84, column 21): " + [ v.result.constructor.name ]);
      })();
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ programArea(state.isExecutable), (function () {
          ...
          throw new Error("Failed pattern match at Component (line 55, column 7 - line 60, column 21): " + [ state.result.constructor.name ]);
      })() ]);
  };
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof ExecuteProgram) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $28.result = Data_Maybe.Nothing.value;
                      $28.isExecutable = false;
                      return $28;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Brainfuck.run(Effect.monadEffect)(Brainfuck_Interp_Stream.defaultStream)(Brainfuck_Interp_Log.noLog(Effect.monadEffect))(Brainfuck_Program.fromString(v1.program))))(function (res) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $31.result = new Data_Maybe.Just(res);
          ...
          throw new Error("Failed pattern match at Component (line 101, column 3 - line 109, column 61): " + [ v.constructor.name ]);
      };
  };
