...
(function($PS) {
  ...
  var questionAff = function (q) {
      return function ($$interface) {
          var go = function (handler) {
              return function __do() {
                  Node_ReadLine.question(q)(function ($10) {
                      return handler(Data_Either.Right.create($10));
                  })($$interface)();
  ...
  exports["read"] = read;
  exports["write"] = write;
  exports["questionAff"] = questionAff;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Brainfuck.Cli.State"] = $PS["Brainfuck.Cli.State"] || {};
  var exports = $PS["Brainfuck.Cli.State"];
  var Data_String_CodeUnits = $PS["Data.String.CodeUnits"];
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Brainfuck.Cli.Util"] = $PS["Brainfuck.Cli.Util"] || {};
  var exports = $PS["Brainfuck.Cli.Util"];
  var Brainfuck_Cli_State = $PS["Brainfuck.Cli.State"];
  var Brainfuck_Error = $PS["Brainfuck.Error"];
  var Brainfuck_Interp = $PS["Brainfuck.Interp"];
  var Brainfuck_Interp_Stream = $PS["Brainfuck.Interp.Stream"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var questionAndReadChar = function (dictMonadAff) {
      return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](dictMonadAff.MonadEffect0()))(Node_ReadLine.createConsoleInterface(Node_ReadLine.noCompletion)))(function ($$interface) {
          return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Effect_Aff_Class.liftAff(Brainfuck_Interp["$_MonadAffInterp_11"](dictMonadAff))(Brainfuck_Interp_Stream.questionAff("input> ")($$interface)))(function (s) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](dictMonadAff.MonadEffect0()))(Node_ReadLine.close($$interface)))(function () {
                  ...
                  throw new Error("Failed pattern match at Brainfuck.Cli.Util (line 80, column 3 - line 85, column 33): " + [ v.constructor.name ]);
              });
          });
      });
  };
  ...
  var move = function (dictMonadEffect) {
      return function (x) {
          return function (state) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"](dictMonadEffect.Monad0()))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](dictMonadEffect))(Effect_Ref.modify_(Brainfuck_Cli_State.modifyY(function (v) {
                  return v + x | 0;
              }))(state)))(function () {
                  var $14 = x > 0;
                  if ($14) {
  ...
  var moveAt = function (dictMonadEffect) {
      return function (y) {
          return function (state) {
              return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"](dictMonadEffect.Monad0()))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](dictMonadEffect))(Data_Functor.map(Effect.functorEffect)(Brainfuck_Cli_State.dist(y))(Effect_Ref.read(state))))(function (dist) {
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Brainfuck.Cli"] = $PS["Brainfuck.Cli"] || {};
  var exports = $PS["Brainfuck.Cli"];
  var Brainfuck_Cli_State = $PS["Brainfuck.Cli.State"];
  var Brainfuck_Cli_Util = $PS["Brainfuck.Cli.Util"];
  var Brainfuck_Command = $PS["Brainfuck.Command"];
  var Brainfuck_Env = $PS["Brainfuck.Env"];
  var Brainfuck_Interp = $PS["Brainfuck.Interp"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var showMemory = function (dptr) {
      return function (memory) {
          return Data_String_Common.joinWith(" ")(mapWithASpecialIndex(dptr)((function () {
              ...
              return function ($13) {
                  return Brainfuck_Cli_Util.highlight($12($13));
              };
  ...
  var showProgram = function (iptr) {
      return function (v) {
          return Data_String_Common.joinWith("")(mapWithASpecialIndex(iptr)((function () {
              ...
              return function ($15) {
                  return Brainfuck_Cli_Util.highlight($14($15));
              };
          })())(Data_Show.show(Brainfuck_Command["$_ShowCommand_2"]))(v));
      };
  };
  var cliStream = function (dictMonadAff) {
      return function (cliState) {
          var output = function (c) {
              return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](dictMonadAff.MonadEffect0()))(Effect_Ref.modify(Brainfuck_Cli_State.appendOutput(c))(cliState)))(function (st) {
                  return Brainfuck_Cli_Util.printAt(dictMonadAff.MonadEffect0())(2)(cliState)(Brainfuck_Cli_State.getOutput(st));
              });
          };
          var input = Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.moveAt(dictMonadAff.MonadEffect0())(2)(cliState))(function () {
              return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.questionAndReadChar(dictMonadAff))(function (s) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.up(dictMonadAff.MonadEffect0())(1))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.clearLine(dictMonadAff.MonadEffect0()))(function () {
  ...
  var cliLog = function (dictMonadAff) {
      return function (cliState) {
          var onState = function (v) {
              return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Data_Functor.map(Brainfuck_Interp["$_FunctorInterp_2"](((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0()))(Brainfuck_Env.getProgram)(Control_Monad_Reader_Class.ask(Brainfuck_Interp["$_MonadAskEnvInterp_8"]((dictMonadAff.MonadEffect0()).Monad0()))))(function (program) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.printAt(dictMonadAff.MonadEffect0())(0)(cliState)(showProgram(v.iptr)(program)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.printAt(dictMonadAff.MonadEffect0())(1)(cliState)(showMemory(v.dptr)(v.memory)))(function () {
                          return Effect_Aff_Class.liftAff(Brainfuck_Interp["$_MonadAffInterp_11"](dictMonadAff))(Effect_Aff.delay(100.0));
                      });
                  });
              });
          };
          var onStart = Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"]((dictMonadAff.MonadEffect0()).Monad0()))(Brainfuck_Cli_Util.newLineTimes(dictMonadAff.MonadEffect0())(4))(function () {
              return Brainfuck_Cli_Util.up(dictMonadAff.MonadEffect0())(4);
          });
          var onEnd = Brainfuck_Cli_Util.down(dictMonadAff.MonadEffect0())(4);
          return {
              onStart: onStart,
              onState: onState,
              onCmd: function (v) {
...
(function($PS) {
  ...
  var Brainfuck_Cli = $PS["Brainfuck.Cli"];
  var Brainfuck_Cli_State = $PS["Brainfuck.Cli.State"];
  var Brainfuck_Program = $PS["Brainfuck.Program"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];                
  var main = function __do() {
      var ref = Brainfuck_Cli_State.init();
      return Effect_Aff.launchAff_(Brainfuck.run(Effect_Aff.monadAff)(Brainfuck_Cli.cliStream(Effect_Aff_Class.monadAffAff)(ref))(Brainfuck_Cli.cliLog(Effect_Aff_Class.monadAffAff)(ref))(Brainfuck_Program.fromString(",>,>,<<+.>+.>+.")))();
  };
  exports["main"] = main;
})(PS);
PS["Main"].main();