...
(function($PS) {
  ...
  var $dollar_ShowError_0 = new Data_Show.Show(function (err) {
      if (err instanceof IPtrOutOfRange) {
          return "Error: Instruction pointer out of range";
      };
      if (err instanceof DPtrOutOfRange) {
          return "Error: Data oointer out of range";
      };
      if (err instanceof CharDecodeFailed) {
          return "Error: Failed to decode integer to char";
      };
      if (err instanceof CharInputFailed) {
          return "Error: Failed to input char";
      };
      throw new Error("Failed pattern match at Brainfuck.Error (line 15, column 5 - line 19, column 55): " + [ err.constructor.name ]);
  });
  exports["IPtrOutOfRange"] = IPtrOutOfRange;
  exports["DPtrOutOfRange"] = DPtrOutOfRange;
  exports["CharDecodeFailed"] = CharDecodeFailed;
  exports["$_ShowError_0"] = $dollar_ShowError_0;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
              ...
              var loop = Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"](dictMonad))(Data_Functor.map(Brainfuck_Interp["$_FunctorInterp_2"](((dictMonad.Bind1()).Apply0()).Functor0()))(Brainfuck_Env.getProgram)(Control_Monad_Reader_Class.ask(Brainfuck_Interp["$_MonadAskEnvInterp_8"](dictMonad))))(function (program) {
                  return Control_Bind.bind(Brainfuck_Interp["$_BindInterp_5"](dictMonad))(Control_Monad_State_Class.get(Brainfuck_Interp["$_MonadStateStateInterp_7"](dictMonad)))(function (state) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"](dictMonad))(Brainfuck_Interp_Log.logState(log)(state))(function () {
                          ...
                          throw new Error("Failed pattern match at Brainfuck (line 58, column 7 - line 67, column 20): " + [ v.constructor.name ]);
                      });
                  });
              });
  ...
  var runWithMemorySize = function (dictMonad) {
      return function (stream) {
          return function (log) {
              return function (memSize) {
                  return function (program) {
                      var state = {
                          iptr: 0,
                          dptr: 0,
                          memory: Data_Array.replicate(memSize)(0)
                      };
                      return Brainfuck_Interp.runInterp(dictMonad)(interpProgram(dictMonad)(stream)(log))(Brainfuck_Env.makeEnv(program))(state);
                  };
              };
          };
      };
  };
  exports["runWithMemorySize"] = runWithMemorySize;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
...
(function($PS) {
  ...
  var ChangeProgram = (function () {
      function ChangeProgram(value0) {
          this.value0 = value0;
      };
      ChangeProgram.create = function (value0) {
          return new ChangeProgram(value0);
      };
  ...
  var ExecuteProgram = (function () {
      ...
      ExecuteProgram.value = new ExecuteProgram();
  ...
  var RequestInput = (function () {
      ...
      RequestInput.value = new RequestInput();
      return RequestInput;
  })();
  var ChangeInput = (function () {
      function ChangeInput(value0) {
          this.value0 = value0;
      };
      ChangeInput.create = function (value0) {
          return new ChangeInput(value0);
      };
      return ChangeInput;
  })();
  var ConfirmInput = (function () {
      ...
      ConfirmInput.value = new ConfirmInput();
      return ConfirmInput;
  })();
  var RequestLogState = (function () {
      function RequestLogState(value0) {
          this.value0 = value0;
      };
      RequestLogState.create = function (value0) {
          return new RequestLogState(value0);
      };
      return RequestLogState;
  })();
  var programArea = function (isExecutable) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("program-area") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(ChangeProgram.create), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return ExecuteProgram.value;
      }), Halogen_HTML_Properties.enabled(isExecutable) ])([ Halogen_HTML_Core.text("Execute") ]) ]);
  };
  var outputArea = function (output) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("output-area") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("output-area_label") ])([ Halogen_HTML_Core.text("output>") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("output-area_body") ])([ Halogen_HTML_Core.text(output) ]) ]);
  };
  ...
  var memoryLogArea = function (dptr) {
      return function (memory) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("memory-log-area") ])(mapWithASpecialIndex(dptr)(function (dat) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("memory-log-area_log-highlight") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(dat)) ]);
          })(function (dat) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("memory-log-area_log-usual") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(dat)) ]);
          })(memory));
      };
  };
  var programLogArea = function (iptr) {
      return function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("program-log-area") ])(mapWithASpecialIndex(iptr)(function (cmd) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("program-log-area_log-highlight") ])([ Halogen_HTML_Core.text(Data_Show.show(Brainfuck_Command["$_ShowCommand_2"])(cmd)) ]);
          })(function (cmd) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("program-log-area_log-usual") ])([ Halogen_HTML_Core.text(Data_Show.show(Brainfuck_Command["$_ShowCommand_2"])(cmd)) ]);
          })(v));
      };
  };
  var stateArea = function (program) {
      return function (stateMay) {
          if (stateMay instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("state-area") ])([ programLogArea(stateMay.value0.iptr)(program), memoryLogArea(stateMay.value0.dptr)(stateMay.value0.memory) ]);
          };
          if (stateMay instanceof Data_Maybe.Nothing) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("state-area") ])([  ]);
          };
          throw new Error("Failed pattern match at Component (line 100, column 3 - line 109, column 11): " + [ stateMay.constructor.name ]);
      };
  };
  var logo = Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("title") ])([ Halogen_HTML_Core.text("Brainfuck") ]);
  var interpResult = function (resultMay) {
      if (resultMay instanceof Data_Maybe.Just) {
          var message = (function () {
              if (resultMay.value0.result instanceof Data_Either.Right) {
                  return "Succeed";
              };
              if (resultMay.value0.result instanceof Data_Either.Left) {
                  return Data_Show.show(Brainfuck_Error["$_ShowError_0"])(resultMay.value0.result.value0);
              };
              throw new Error("Failed pattern match at Component (line 191, column 13 - line 196, column 25): " + [ resultMay.value0.result.constructor.name ]);
          })();
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("interp-result") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Result> " + message) ]) ]);
      };
      if (resultMay instanceof Data_Maybe.Nothing) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("interp-result") ])([  ]);
      };
      throw new Error("Failed pattern match at Component (line 188, column 3 - line 202, column 58): " + [ resultMay.constructor.name ]);
  };
  var inputArea = function (isInputEnabled) {
      if (isInputEnabled) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-area") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("input-area_label") ])([ Halogen_HTML_Core.text("input> ") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-area_body") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueChange(ChangeInput.create) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return ConfirmInput.value;
          }) ])([ Halogen_HTML_Core.text("submit") ]) ]) ]);
      };
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-area") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("input-area_label") ])([ Halogen_HTML_Core.text("input>") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("input-area_body") ])([  ]) ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("app-outer") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("app") ])([ logo, programArea(state.isExecutable), stateArea(Brainfuck_Program.fromString(state.program))(state.stateMay), inputArea(state.isInputEnabled), outputArea(state.output), interpResult(state.result) ]) ]);
  };
  var initialState = function (avar) {
      return {
          program: "",
          result: Data_Maybe.Nothing.value,
          isExecutable: true,
          streamMay: Data_Maybe.Nothing.value,
          output: "",
          avar: avar,
          input: "",
          isInputEnabled: false,
          logMay: Data_Maybe.Nothing.value,
          stateMay: Data_Maybe.Nothing.value
      };
  };
  var createStream = function (listener) {
      return function (avar) {
          var output = function (c) {
              return Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](Effect_Aff.monadEffectAff))(Halogen_Subscription.notify(listener)(new Output(c)));
          };
          var input = Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"](Effect_Aff.monadAff))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](Effect_Aff.monadEffectAff))(Halogen_Subscription.notify(listener)(RequestInput.value)))(function () {
              return Effect_Aff_Class.liftAff(Brainfuck_Interp["$_MonadAffInterp_11"](Effect_Aff_Class.monadAffAff))(Effect_Aff_AVar.take(avar));
          });
          return {
              input: input,
              output: output
  ...
  var createLog = function (listener) {
      var onState = function (state) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Brainfuck_Interp["$_BindInterp_5"](Effect_Aff.monadAff))(Effect_Class.liftEffect(Brainfuck_Interp["$_MonadEffectInterp_10"](Effect_Aff.monadEffectAff))(Halogen_Subscription.notify(listener)(new RequestLogState(state))))(function () {
              return Effect_Aff_Class.liftAff(Brainfuck_Interp["$_MonadAffInterp_11"](Effect_Aff_Class.monadAffAff))(Effect_Aff.delay(100.0));
          });
      };
      return {
          onStart: Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](Effect_Aff.monadAff))(Data_Unit.unit),
          onState: onState,
          onCmd: function (v) {
              return Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](Effect_Aff.monadAff))(Data_Unit.unit);
          },
          onEnd: Control_Applicative.pure(Brainfuck_Interp["$_ApplicativeInterp_4"](Effect_Aff.monadAff))(Data_Unit.unit)
      };
  };
      ...
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.create))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(v1.emitter))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                          ...
                          $38.streamMay = Data_Maybe.Just.create(createStream(v1.listener)(s.avar));
                          $38.logMay = Data_Maybe.Just.create(createLog(v1.listener));
                          return $38;
                      });
                  });
              });
          };
          if (v instanceof ChangeProgram) {
          ...
          if (v instanceof ExecuteProgram) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.streamMay)(function (s) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.logMay)(function (l) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $48.output = "";
                              $48.result = Data_Maybe.Nothing.value;
                              $48.isExecutable = false;
                              return $48;
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Brainfuck.runWithMemorySize(Effect_Aff.monadAff)(s)(l)(60)(Brainfuck_Program.fromString(v1.program))))(function (res) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      ...
                                      $51.result = new Data_Maybe.Just(res);
          ...
          if (v instanceof Output) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $57.output = s.output + Data_String_CodeUnits.singleton(v.value0);
                  return $57;
              });
          };
          ...
          if (v instanceof ConfirmInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var v2 = Data_String_CodeUnits.toChar(Data_String_CodeUnits.take(1)(v1.input));
                  if (v2 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $70.input = "";
                          $70.isInputEnabled = false;
                          return $70;
                      }))(function () {
                          return Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_AVar.put(v2.value0)(v1.avar));
                      });
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  throw new Error("Failed pattern match at Component (line 239, column 7 - line 245, column 20): " + [ v2.constructor.name ]);
              });
          };
          if (v instanceof RequestLogState) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $76 = {};
                  for (var $77 in v1) {
                  ...
                  $76.stateMay = new Data_Maybe.Just(v.value0);
                  return $76;
              });
          };
          throw new Error("Failed pattern match at Component (line 208, column 3 - line 248, column 45): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff_AVar.empty)(function (avar) {
          return Halogen_VDom_Driver.runUI(Component.component(Effect_Aff_Class.monadAffAff))(avar)(body);
      });
  }));
  exports["main"] = main;
})(PS);
