...
(function($PS) {
  ...
  var stateArea = function (program) {
      return function (stateMay) {
          ...
          throw new Error("Failed pattern match at Component (line 94, column 3 - line 103, column 11): " + [ stateMay.constructor.name ]);
      };
  };
  var interpResult = function (resultMay) {
      if (resultMay instanceof Data_Maybe.Just) {
          var message = (function () {
              ...
              throw new Error("Failed pattern match at Component (line 185, column 13 - line 190, column 25): " + [ resultMay.value0.result.constructor.name ]);
          })();
      ...
      throw new Error("Failed pattern match at Component (line 182, column 3 - line 196, column 58): " + [ resultMay.constructor.name ]);
  };
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("app-outer") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("app") ])([ programArea(state.isExecutable), stateArea(Brainfuck_Program.fromString(state.program))(state.stateMay), inputArea(state.isInputEnabled), outputArea(state.output), interpResult(state.result) ]) ]);
  };
      ...
      return function (v) {
                  ...
                  return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.streamMay)(function (s) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.logMay)(function (l) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Brainfuck.run(Effect_Aff.monadAff)(s)(l)(Brainfuck_Program.fromString(v1.program))))(function (res) {
          ...
          if (v instanceof ConfirmInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Component (line 233, column 7 - line 239, column 20): " + [ v2.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Component (line 202, column 3 - line 242, column 45): " + [ v.constructor.name ]);
      };
  };
